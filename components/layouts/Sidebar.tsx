...
const Sidebar = () => {
  ...
  return (
    <div
      className={`hidden sm:block absolute z-50 hover:w-48 w-[70px] h-screen bg-zinc-950 border-r hover:border-r-2 border-zinc-700 transition-all duration-75 group hover:shadow-xl shadow-zinc-700`}
    >
                  ...
                  <div className="flex-1 flex -mx-1 overflow-hidden">
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="transition-opacity duration-75 whitespace-nowrap">{item.title}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <Link href="/wallet">
            <div className="mb-[30px]">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex-1 flex -mx-1 overflow-hidden ">
                  <a
                    className={`tracking-wide group cursor-pointer flex text-sm font-medium text-left px-2 py-2.5 w-full h-11 rounded-md items-center  border border-zinc-700 hover:bg-opacity-80 ${
                      pathname === "/wallet" ? "bg-zinc-700" : "bg-zinc-800"
                    }`}
                  >
                    <div className="flex items-center">
                      <span>
                        {pathname === "/wallet" ? (
                          <IoWalletOutline className="text-[30px] mr-[13px] text-cyan-600" />
                        ) : (
          ...
          <div className="mb-[30px]">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex-1 flex -mx-1 overflow-hidden ">
                <a
                  target="_blank"
                  className="tracking-wide group cursor-pointer flex text-sm font-medium text-left px-2 py-2.5 w-full h-11 rounded-md items-center bg-zinc-800 border border-zinc-700"
                >
                  <div className="flex items-center">
              ...
              <div className="flex-1 flex -mx-1 overflow-hidden ">
                <a
                  ...
                  target="_blank"
                  className="tracking-wide group cursor-pointer flex text-sm font-medium text-left px-2 py-2.5 w-full h-11 rounded-md items-center bg-zinc-800  border-zinc-700 hover:bg-opacity-80"
                >
                  <div className="flex items-center">
                    <span className="h-7 w-7 mr-[13px] text-zinc-200">
